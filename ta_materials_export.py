...
include_files = {
    ...
    'tsql_measure_calculation.sql': 'tsql_measure_calculation.sql',
    'postgres_01_load_data.sql': 'postgres_01_load_data.sql',
    'postgres_02_measure_calculation.sql': 'postgres_02_measure_calculation',
